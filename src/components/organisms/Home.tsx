  ...
  return (
    <div className="mt-10 p-10 rounded-xl w-[100%] ml-[55px] bg-white mt-[90px] mb-auto flex flex-wrap gap-[1%] max765:ml-0 max765:p-5">
      <div
        ...
        className="border border-gray-200 rounded-lg shadow-md flex flex-col items-center mb-[15px] bg-white w-[17%] justify-center gap-[8px] min-w-[190px] animate-fade-in hover:shadow-lg"
      >
        <HistoryIcon
