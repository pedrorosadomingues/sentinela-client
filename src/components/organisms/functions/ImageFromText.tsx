...
export default function ImageFromText() {
  ...
  const [generatedImages, setGeneratedImages] = useState<string[]>([
    "", // Placeholder para imagens geradas
    "",
    "",
    "",
  ]);
      ...
      <div className="bg-white p-6 w-full rounded-lg shadow-md mb-6">
        <div className="relative w-full">
          ...
          <button
            ...
            className="absolute flex items-center justify-center right-[20px] h-[35px] bottom-[10px] mt-6 w-[20%] bg-gradient-to-r from-red-500 to-orange-500 text-white py-3 rounded-lg font-bold hover:opacity-90"
          >
